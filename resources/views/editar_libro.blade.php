    ...
    <div class="">
        <div class="row">
            ...
            <div class="col-9">
                ...
                <body>
    <h1>Editar Libro</h1>
    <form action="{{ route('libro.actualizar', $libro->id) }}" method="POST">
        @csrf
        @method('PUT')
        <label for="clave">Clave:</label><br>
        <input type="text" id="clave" name="clave" value="{{ $libro->clave }}"><br>
        
        <label for="nombre">Nombre:</label><br>
        <input type="text" id="nombre" name="nombre" value="{{ $libro->nombre }}"><br>
        
        <label for="autor">Autor:</label><br>
        <input type="text" id="autor" name="autor" value="{{ $libro->autor }}"><br>
        
        <label for="fecha_publicacion">Fecha de Publicación:</label><br>
        <input type="date" id="fecha_publicacion" name="fecha_publicacion" value="{{ $libro->fecha_publicacion }}"><br>
