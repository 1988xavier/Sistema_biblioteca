...
<head>
    ...
    <style>
       .encabezado {
        ...
        .boton {
            float: right; /* Hacer que el botón flote a la derecha */
            margin-right: 10px;
        ...
        <div class="row">
            ...
            <div class="col-9">
                <div class="lista-libros">
                    ...
                    <button class="boton" onclick="window.location.href='/agregar'" style="color: white; font-size: 20px; background-color: #007bff; border: none; padding: 10px 20px; cursor: pointer; margin-top: -60px;">Nuevo</button>
                        ...
                        <tbody>
                            @foreach ($libros as $libro)
                                <tr>
                                    ...
                                    <td>{{ $libro->portada }}</td>
                                    <td>
                                        <form action="{{ route('libro.eliminar', ['id' => $libro->id]) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                    ...
                                    <td>
                                        <a href="{{ route('libro.editar', ['id' => $libro->id]) }}" class="btn btn-primary">Editar</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
